...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sd1_condenser_skill', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, default='', populate_from='name', overwrite=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Skill.slug'
        db.delete_column('sd1_condenser_skill', 'slug')

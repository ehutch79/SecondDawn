...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Character.stripe_customer'
        db.delete_column('sd1_condenser_character', 'stripe_customer')

        # Adding field 'PersonalProfile.stripe_customer'
        db.add_column('sd1_condenser_personalprofile', 'stripe_customer', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Character.stripe_customer'
        db.add_column('sd1_condenser_character', 'stripe_customer', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Deleting field 'PersonalProfile.stripe_customer'
        db.delete_column('sd1_condenser_personalprofile', 'stripe_customer')

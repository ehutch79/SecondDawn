...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feat.slug'
        db.add_column('sd1_condenser_feat', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, default='', populate_from='name', overwrite=True, db_index=True), keep_default=False)

        # Adding field 'Profession.slug'
        db.add_column('sd1_condenser_profession', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, default='', populate_from='name', overwrite=True, db_index=True), keep_default=False)

        # Adding field 'Header.slug'
        db.add_column('sd1_condenser_header', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, default='', populate_from='name', overwrite=True, db_index=True), keep_default=False)

        # Adding field 'Faction.slug'
        db.add_column('sd1_condenser_faction', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, default='', populate_from='name', overwrite=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feat.slug'
        db.delete_column('sd1_condenser_feat', 'slug')

        # Deleting field 'Profession.slug'
        db.delete_column('sd1_condenser_profession', 'slug')

        # Deleting field 'Header.slug'
        db.delete_column('sd1_condenser_header', 'slug')

        # Deleting field 'Faction.slug'
        db.delete_column('sd1_condenser_faction', 'slug')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProfessionBought.pp'
        db.delete_column('sd1_condenser_professionbought', 'pp')

        # Adding field 'ProfessionBought.score'
        db.add_column('sd1_condenser_professionbought', 'score', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ProfessionBought.pp'
        db.add_column('sd1_condenser_professionbought', 'pp', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)

        # Deleting field 'ProfessionBought.score'
        db.delete_column('sd1_condenser_professionbought', 'score')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProfessionBought.profession'
        db.alter_column('sd1_condenser_professionbought', 'profession_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['sd1_condenser.Profession']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProfessionBought.profession'
        db.alter_column('sd1_condenser_professionbought', 'profession_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sd1_condenser.Profession']))

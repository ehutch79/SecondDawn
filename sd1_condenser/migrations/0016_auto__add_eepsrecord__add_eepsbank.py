...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EepsRecord'
        db.create_table('sd1_condenser_eepsrecord', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('eeps', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('reason', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('sd1_condenser', ['EepsRecord'])

        # Adding model 'EepsBank'
        db.create_table('sd1_condenser_eepsbank', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('eeps', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('sd1_condenser', ['EepsBank'])


    def backwards(self, orm):
        
        # Deleting model 'EepsRecord'
        db.delete_table('sd1_condenser_eepsrecord')

        # Deleting model 'EepsBank'
        db.delete_table('sd1_condenser_eepsbank')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Skill.activation'
        db.alter_column('sd1_condenser_skill', 'activation', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'Skill.activation'
        db.alter_column('sd1_condenser_skill', 'activation', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PersonalProfile.allergies'
        db.alter_column('sd1_condenser_personalprofile', 'allergies', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'PersonalProfile.medical'
        db.alter_column('sd1_condenser_personalprofile', 'medical', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PersonalProfile.allergies'
        raise RuntimeError("Cannot reverse this migration. 'PersonalProfile.allergies' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PersonalProfile.medical'
        raise RuntimeError("Cannot reverse this migration. 'PersonalProfile.medical' and its values cannot be restored.")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'EepsRecord', fields ['user']
        db.delete_unique('sd1_condenser_eepsrecord', ['user_id'])

        # Changing field 'EepsRecord.user'
        db.alter_column('sd1_condenser_eepsrecord', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'EepsRecord.reason'
        db.alter_column('sd1_condenser_eepsrecord', 'reason', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'EepsRecord.user'
        db.alter_column('sd1_condenser_eepsrecord', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Adding unique constraint on 'EepsRecord', fields ['user']
        db.create_unique('sd1_condenser_eepsrecord', ['user_id'])

        # User chose to not deal with backwards NULL issues for 'EepsRecord.reason'
        raise RuntimeError("Cannot reverse this migration. 'EepsRecord.reason' and its values cannot be restored.")
    ...
    models = {
        ...
        'sd1_condenser.character': {
            ...
            'can_spend_eeps': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sd1_condenser_character', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 3, 3), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Character.created'
        db.delete_column('sd1_condenser_character', 'created')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SkillBought.id'
        db.alter_column('sd1_condenser_skillbought', 'id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True))

        # Changing field 'FactionStatus.id'
        db.alter_column('sd1_condenser_factionstatus', 'id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True))

        # Changing field 'ProfessionBought.id'
        db.alter_column('sd1_condenser_professionbought', 'id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'SkillBought.id'
        db.alter_column('sd1_condenser_skillbought', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'FactionStatus.id'
        db.alter_column('sd1_condenser_factionstatus', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'ProfessionBought.id'
        db.alter_column('sd1_condenser_professionbought', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

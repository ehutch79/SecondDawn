...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProfSkill'
        db.create_table('sd1_condenser_profskill', (
            ...
            ('playable', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('components', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('requires_novel', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('cost', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('incr_cost', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('variable_cost', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('rank', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('sd1_condenser', ['ProfSkill'])

        # Adding M2M table for field profession on 'ProfSkill'
        db.create_table('sd1_condenser_profskill_profession', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profskill', models.ForeignKey(orm['sd1_condenser.profskill'], null=False)),
            ('profession', models.ForeignKey(orm['sd1_condenser.profession'], null=False))
        ))
        db.create_unique('sd1_condenser_profskill_profession', ['profskill_id', 'profession_id'])

        # Adding M2M table for field required_skills on 'ProfSkill'
        db.create_table('sd1_condenser_profskill_required_skills', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_profskill', models.ForeignKey(orm['sd1_condenser.profskill'], null=False)),
            ('to_profskill', models.ForeignKey(orm['sd1_condenser.profskill'], null=False))
        ))
        db.create_unique('sd1_condenser_profskill_required_skills', ['from_profskill_id', 'to_profskill_id'])

        # Adding model 'ProfessionAction'
        db.create_table('sd1_condenser_professionaction', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('bga', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sd1_condenser.BGAction'], null=True, blank=True)),
            ('use', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('learn', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('pp_spent', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('prof_skill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sd1_condenser.ProfSkill'], null=True, blank=True)),
            ('specifics', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('novel', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('sd1_condenser', ['ProfessionAction'])

        # Adding model 'ProfSkillLearned'
        db.create_table('sd1_condenser_profskilllearned', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('char', self.gf('django.db.models.fields.related.ForeignKey')(related_name='profession_skills', to=orm['sd1_condenser.Character'])),
            ('skill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sd1_condenser.ProfSkill'])),
            ('pp_paid', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('specifics', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('novel', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('sd1_condenser', ['ProfSkillLearned'])

        # Adding model 'BGAction'
        db.create_table('sd1_condenser_bgaction', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sd1_events.EventInfo'], null=True, blank=True)),
            ('is_ingame', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('profession', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sd1_condenser.ProfessionBought'], null=True, blank=True)),
        ...
        db.send_create_signal('sd1_condenser', ['BGAction'])

        # Adding field 'Character.is_updated'
        db.add_column('sd1_condenser_character', 'is_updated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ProfSkill'
        db.delete_table('sd1_condenser_profskill')

        # Removing M2M table for field profession on 'ProfSkill'
        db.delete_table('sd1_condenser_profskill_profession')

        # Removing M2M table for field required_skills on 'ProfSkill'
        db.delete_table('sd1_condenser_profskill_required_skills')

        # Deleting model 'ProfessionAction'
        db.delete_table('sd1_condenser_professionaction')

        # Deleting model 'ProfSkillLearned'
        db.delete_table('sd1_condenser_profskilllearned')

        # Deleting model 'BGAction'
        db.delete_table('sd1_condenser_bgaction')

        # Deleting field 'Character.is_updated'
        db.delete_column('sd1_condenser_character', 'is_updated')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 1, 12, 24, 676637)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 1, 12, 24, 676483)'}),
        ...
        'sd1_condenser.profskill': {
            ...
            'profession': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['sd1_condenser.Profession']", 'null': 'True', 'blank': 'True'}),

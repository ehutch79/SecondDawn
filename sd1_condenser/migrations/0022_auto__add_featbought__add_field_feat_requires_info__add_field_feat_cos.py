...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FeatBought'
        db.create_table('sd1_condenser_featbought', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('char', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feats', to=orm['sd1_condenser.Character'])),
            ('feat', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bought_by', to=orm['sd1_condenser.Feat'])),
            ('info', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('paid_total', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('sd1_condenser', ['FeatBought'])

        # Adding field 'Feat.requires_info'
        db.add_column('sd1_condenser_feat', 'requires_info', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Feat.cost'
        db.add_column('sd1_condenser_feat', 'cost', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Feat.incr_cost'
        db.add_column('sd1_condenser_feat', 'incr_cost', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FeatBought'
        db.delete_table('sd1_condenser_featbought')

        # Deleting field 'Feat.requires_info'
        db.delete_column('sd1_condenser_feat', 'requires_info')

        # Deleting field 'Feat.cost'
        db.delete_column('sd1_condenser_feat', 'cost')

        # Deleting field 'Feat.incr_cost'
        db.delete_column('sd1_condenser_feat', 'incr_cost')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EepsRecord.when'
        db.add_column('sd1_condenser_eepsrecord', 'when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 3, 30), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EepsRecord.when'
        db.delete_column('sd1_condenser_eepsrecord', 'when')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sd1_condenser_skill_required_skills', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_skill', models.ForeignKey(orm['sd1_condenser.skill'], null=False)),
            ('to_skill', models.ForeignKey(orm['sd1_condenser.skill'], null=False))
        ))
        db.create_unique('sd1_condenser_skill_required_skills', ['from_skill_id', 'to_skill_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field required_skills on 'Skill'
        db.delete_table('sd1_condenser_skill_required_skills')
    ...
    models = {
        ...
        'sd1_condenser.skill': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'required_skills': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'required_skills_rel_+'", 'to': "orm['sd1_condenser.Skill']"})
        }
    }

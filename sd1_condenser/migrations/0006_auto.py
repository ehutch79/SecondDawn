...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field grants on 'Skill'
        db.create_table('sd1_condenser_skill_grants', (
        ...
        db.create_unique('sd1_condenser_skill_grants', ['from_skill_id', 'to_skill_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field grants on 'Skill'
        db.delete_table('sd1_condenser_skill_grants')

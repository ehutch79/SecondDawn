...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('django_neve_profile', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, default='', populate_from='user__email', overwrite=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.slug'
        db.delete_column('django_neve_profile', 'slug')
    ...
    models = {
        ...
        'django_neve.profile': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'slug': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '50', 'separator': "u'-'", 'blank': 'True', 'populate_from': "'user__email'", 'overwrite': 'True', 'db_index': 'True'}),

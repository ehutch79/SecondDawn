...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Receipt.paid'
        db.add_column('sd1_events_receipt', 'paid', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Receipt.paid'
        db.delete_column('sd1_events_receipt', 'paid')

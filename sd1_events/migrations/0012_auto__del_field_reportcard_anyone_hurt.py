...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ReportCard.anyone_hurt'
        db.delete_column('sd1_events_reportcard', 'anyone_hurt')


    def backwards(self, orm):
        
        # Adding field 'ReportCard.anyone_hurt'
        db.add_column('sd1_events_reportcard', 'anyone_hurt', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 27, 3, 11, 20, 451634)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 27, 3, 11, 20, 451478)'}),

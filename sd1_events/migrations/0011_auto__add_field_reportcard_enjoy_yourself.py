...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportCard.enjoy_yourself'
        db.add_column('sd1_events_reportcard', 'enjoy_yourself', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReportCard.enjoy_yourself'
        db.delete_column('sd1_events_reportcard', 'enjoy_yourself')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 27, 1, 30, 45, 680482)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 27, 1, 30, 45, 680330)'}),

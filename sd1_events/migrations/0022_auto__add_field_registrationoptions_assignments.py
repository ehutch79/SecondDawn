...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegistrationOptions.assignments'
        db.add_column('sd1_events_registrationoptions', 'assignments', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegistrationOptions.assignments'
        db.delete_column('sd1_events_registrationoptions', 'assignments')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 5, 2, 22, 51, 547538)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 5, 2, 22, 51, 547383)'}),
        ...
        'sd1_events.eventregistration': {
            'Meta': {'ordering': "['event__event_start', 'user__first_name']", 'object_name': 'EventRegistration'},
            ...
            'cabin_num': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'eeps': ('django.db.models.fields.IntegerField', [], {'default': '300'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sd1_events.EventInfo']"}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'new_char': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'sd1_events.registrationoptions': {
            ...
            'assignments': ('django.db.models.fields.IntegerField', [], {'default': '1'}),

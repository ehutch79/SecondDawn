...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventRegistration.cabin_num'
        db.add_column('sd1_events_eventregistration', 'cabin_num', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventRegistration.cabin_num'
        db.delete_column('sd1_events_eventregistration', 'cabin_num')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 22, 46, 37, 621517)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 22, 46, 37, 621362)'}),

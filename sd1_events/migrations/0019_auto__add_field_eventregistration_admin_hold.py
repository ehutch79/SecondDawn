...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventRegistration.admin_hold'
        db.add_column('sd1_events_eventregistration', 'admin_hold', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventRegistration.admin_hold'
        db.delete_column('sd1_events_eventregistration', 'admin_hold')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 3, 2, 34, 12, 489280)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 3, 2, 34, 12, 489097)'}),

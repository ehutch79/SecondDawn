...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventInfo.build_blackout_start'
        db.add_column('sd1_events_eventinfo', 'build_blackout_start', self.gf('django.db.models.fields.DateField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'EventInfo.build_backout_start'
        raise RuntimeError("Cannot reverse this migration. 'EventInfo.build_backout_start' and its values cannot be restored.")

        # Deleting field 'EventInfo.build_blackout_start'
        db.delete_column('sd1_events_eventinfo', 'build_blackout_start')

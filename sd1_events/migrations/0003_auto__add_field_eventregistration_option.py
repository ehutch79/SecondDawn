...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventRegistration.option'
        db.add_column('sd1_events_eventregistration', 'option', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['sd1_events.RegistrationOptions']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventRegistration.option'
        db.delete_column('sd1_events_eventregistration', 'option_id')

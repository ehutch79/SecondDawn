...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sd1_events_receipt', (
        ...
        db.send_create_signal('sd1_events', ['Receipt'])

        # Adding M2M table for field regs on 'Receipt'
        db.create_table('sd1_events_receipt_regs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('receipt', models.ForeignKey(orm['sd1_events.receipt'], null=False)),
            ('eventregistration', models.ForeignKey(orm['sd1_events.eventregistration'], null=False))
        ))
        db.create_unique('sd1_events_receipt_regs', ['receipt_id', 'eventregistration_id'])


    def backwards(self, orm):
        
        # Deleting model 'Receipt'
        db.delete_table('sd1_events_receipt')

        # Removing M2M table for field regs on 'Receipt'
        db.delete_table('sd1_events_receipt_regs')

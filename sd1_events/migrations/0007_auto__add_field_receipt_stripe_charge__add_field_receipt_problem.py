...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Receipt.stripe_charge'
        db.add_column('sd1_events_receipt', 'stripe_charge', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True), keep_default=False)

        # Adding field 'Receipt.problem'
        db.add_column('sd1_events_receipt', 'problem', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Receipt.stripe_charge'
        db.delete_column('sd1_events_receipt', 'stripe_charge')

        # Deleting field 'Receipt.problem'
        db.delete_column('sd1_events_receipt', 'problem')

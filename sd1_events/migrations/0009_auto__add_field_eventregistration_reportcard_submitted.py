...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventRegistration.reportcard_submitted'
        db.add_column('sd1_events_eventregistration', 'reportcard_submitted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventRegistration.reportcard_submitted'
        db.delete_column('sd1_events_eventregistration', 'reportcard_submitted')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 26, 21, 6, 37, 9029)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 26, 21, 6, 37, 8872)'}),

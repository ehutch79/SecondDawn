...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sd1_events_reportcard', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('reg', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sd1_events.EventRegistration'], unique=True)),
            ('likely_to_return', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('rules', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('food', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('puzzles', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('role_playing', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('costumes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('overall', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('anyone_help', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('anyone_hurt', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('plots', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('sd1_events', ['ReportCard'])


    def backwards(self, orm):
        
        # Deleting model 'ReportCard'
        db.delete_table('sd1_events_reportcard')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 27, 0, 29, 13, 721137)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 27, 0, 29, 13, 720981)'}),
        ...
        'sd1_events.reportcard': {
            ...
            'anyone_hurt': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
